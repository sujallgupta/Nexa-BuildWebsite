...
useEffect(()=>{
  ...
  return project ? (
        ...
        <div className="flex items-center gap-2 sm:min-w-90 text-nowrap">
          ...
          <div className="max-w-64 sm:max-w-xs">
            ...
            <p className="text-xs text-gray-400 -mt-0.5">
              Previewing last saved versions
            </p>
          </div>
    ...
    {/* left Section */}
   <div className="w-[360px] min-w-[320px] max-w-[380px] bg-gray-950 border-gray-800 relative z-10">
    ...
    <div className="w-full h-full rounded-xl shadow-2xl p-3">
    ...
    <div className="flex items-center justify-center h-screen">
      <p className="text-center text-2xl font-medium text-gray-200 leading-relaxed">
        We’re unable to load your projects.
        <br />
        Please try again.
      </p>
    </div>
