...
const steps = [
  ...
  { icon: SquareIcon, label: "Designing the layout structure..." },
  { icon: TriangleIcon, label: "Building UI components..." },
  { icon: CircleIcon, label: "Finalizing your interface..." },
];
...
const LoaderSteps = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white">
      ...
      {/* Step label – smooth fade animation (no invisible start state) */}
      <p
        key={current}
